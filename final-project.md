...
permalink: /2019/proj/pfinal/
---

This article is written by Chahat Deep Singh. 
If you have any questions/corrections regarding the article, please email at chahat[at]terpmail[dot]umd[edu]. For students in the class, please let us know via Piazza post.
...
- [Unsupervised Deep Learning](#unsup)
...
- [I.3. Phase 1: Traditional Approach](#trad)
	- [I.3.1. Feature Matching](#featmatch)
	- [I.3.2. Estimating Fundamental Matrix](#estfundmatrix)  
		- [I.3.2.1. Epipolar Geometry](#epipole)
		- [I.3.2.2. Fundamental Matrix](#fundmatrix)
		- [I.3.2.3. Match Outlier Rejection using RANSAC](#ransac)

	- [I.3.3. Estimate *Essential Matrix* from Fundamental Matrix](#estE)

	- [I.3.4. Estimate Camera Pose from Essential Matrix](#essential)

	- [I.3.5. Check for Cheirality Condition using Triangulation](#tri)
		- [I.3.5.1. Non-Linear Triangulation](#nonlintri)
	- [I.3.6. Perspective-$$n$$-points](#pnp)
		- [I..6.1. Linear Camera Pose Estimation](#campose)
		- [I.3.6.2. PnP RANSAC](#pnpransac)
		- [I.3.6.3. NonLinear PnP](#nonpnp)
	- [I.3.7. Bundle Adjustment](#ba)
		- [I.3.7.1. Visibility Matrix](#vismatrix)
		- [I.3.7.2. Bundle Adjustment](#sba)

- [I.4. Putting the pipeline together](#combine)
...
- [II.4. Notes about the dataset](#dataset)
  - [II.4.1. Note about the SfMLearner Code](#code)
...
<a name='trad'></a>
## I.3. Traditional Approach to the SfM problem

<a name='featmatch'></a>
### I.3.1. Feature Matching, Fundamental Matrix and RANSAC
...
### I.3.2. Estimating Fundamental Matrix 
...
<a name='ransac'></a>
#### I.3.2.3. Match Outlier Rejection via RANSAC
...
<a name='estE'></a>
### I.3.3. Estimate *Essential Matrix* from Fundamental Matrix
...
<a name='essential'></a>
### I.3.4. Estimate **Camera Pose** from Essential Matrix
...
<a name='tri'></a>
### I.3.5. **Triangulation** Check for **Cheirality Condition** 
...
<a name='nonlintri'></a>
#### I.3.5.1. Non-Linear Triangulation
...
### I.3.6.1 Linear Camera Pose Estimation
...
**You can use any online open source tools for Bundle Adjustment.**
...
# Part II: Learning the Structure from Motion | An Unsupervised Approach

<a name='intro-unsup'></a>
...
Your task is to analyze and make [SfMLearner](https://people.eecs.berkeley.edu/~tinghuiz/projects/SfMLearner/cvpr17_sfm_final.pdf) 'better'! When we say better, it means that the error in depth and pose estimation must be less than that of SfMLearner's paper on different empirical evaluation scales. Research papers like [GeoNet](https://arxiv.org/pdf/1803.02276.pdf) might help you in improving the results. Although, research papers in this field are in abundance. Feel free to search through the internet. 

**YOU ARE ALLOWED TO USE ANY OPEN SOURCE CODE FOR PHASE 2!** 
...
### II.4.1 Note about the SfMLearner Code
...
<a name='files'></a>
### III.1. File tree and naming

Your submission on ELMS/Canvas must be a ``zip`` file, following the naming convention ``YourDirectoryID_pfinal.zip``. If you email ID is ``abc@umd.edu`` or ``abc@terpmail.umd.edu``, then your ``DirectoryID`` is ``abc``. For our example, the submission file should be named ``abc_pfinal.zip``. The file **must have the following directory structure** because we'll be autograding assignments. The file to run for your project should be called ``Wrapper.py``. You can have any helper functions in sub-folders as you wish, be sure to index them using relative paths and if you have command line arguments for your Wrapper codes, make sure to have default values too. Please provide detailed instructions on how to run your code in ``README.md`` file. Please **DO NOT** include data in your submission.

```
YourDirectoryID_pfinal.zip
├── README.md
├── Code
|   ├── Part 1   
|   |   ├── GetInliersRANSAC.py
