...
- [3. Phase 1: Traditional Approach](#ph1)
	- [3.1. Corner Detection](#corner)
	- [3.2. Adaptive Non-Maximal Suppression (ANMS)](#anms)
	- [3.3. Feature Descriptor](#feat-descriptor)
	- [3.4. Feature Matching](#feat-matching)
	- [3.5. RANSAC for outlier rejection and to estimate Robust Homography](#homography)
	- [3.6. Blending Images](#blending)
- [4. Phase 2: Deep Learning Approach](#ph2)
	- [4.1. Data Generation](#datagen)
	- [4.2. Supervised Approach](#ph2sup)
	- [4.3. Unsupervised Approach](#ph2unsup)
...
<a name='ph2'></a>
## 4. Phase 2: Deep Learning Approach
